      ...
      Create an account
        ...
        <div className="mt-10 sm:mx-auto sm:w-full md:max-w-lg sm:max-w-xl">
          <form className="space-y-8" action="#" method="POST">
            ...
            <div>
              <label htmlFor="email" className="block text-md font-body font-medium leading-6 text-gray-900">
                User Name
              </label>
              <div className="mt-2">
                <input
              ...
              <div>
              <label htmlFor="email" className="block text-md font-medium font-body leading-6 text-gray-900">
                Email Address
              </label>
              <div className="mt-2">
                <input
            ...
            <div>
              <div className="flex items-center justify-between">
                <label htmlFor="password" className="block text-md font-medium font-body leading-6 text-gray-900">
                  Password
                </label>
              </div>
              <div className="mt-2">
          ...
          <p className="mt-10 text-center text-sm text-gray-500 font-body">
            ...
            <a href="#" className="font-semibold leading-6 text-buttonGreen ">
              Sign in
            </a>
          </p>
        </div>
