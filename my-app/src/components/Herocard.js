  ...
  return (
   ...
   <div className="flex md:hidden flex-col w-full h-[100vh]  pt-12  ">
      <div
        ...
        style={{ fontSize: "15vw" }}
      >
        <div className="model flex justify-center bg-customGreen py-6 rounded-[0px 12px 0px 12px]">
        <img
            src={props.modelImage}
            alt="Bike"
      ...
      <div className="flex flex-row xs:flex-row md:hidden justify-center py-[2rem] gap-[1.8rem] items-center">
      <Iconcard iconImage={batteryIcon} iconDetails={props.batteryDetails} iconMoreDetails={props.batteryMoredetails}/>
      <Iconcard iconImage={speedIcon} iconDetails={props.speedDetails} iconMoreDetails={props.batteryMoredetails}/>
      <Iconcard iconImage={weightIcon} iconDetails={props.weightDetails} iconMoreDetails={props.weightMoredetails}/>

      </div>

    
      <div
        className="flex absolute flex-col w-full  md:w-[30%] bg-customGreen p-5 bottom-[0%] "
        // style={{bottom: 0, right: 0 }}
      >
        <div className="flex  md:flex-row items-center justify-center md:gap-12 gap-6  px-4 py-4">
          <div className="flex flex-col gap-1 justify-center items-center">
