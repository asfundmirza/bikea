...
const ModalPage = () => {
  return (
    <div>
      ...
      <div className="flex flex-col-reverse md:flex-row mt-10 mb-10">
        <div className="flex items-center flex-col  justify-center md:justify-start mt-5 md:mt-[100px] flex-1 md:flex-[0.9]">
            ...
            <div className="flex flex-col mt-5 px-5 gap-3">
              <div className="flex flex-col ">
                <p className="leading-tight">
                  <span className="font-bold">Battery Timing:</span>
                  The Aero Bike is equipped with a powerful lithium-ion battery
                  that offers an impressive 80 kilometers (37 miles) of riding
                  on a single charge.
                </p>
              </div>
              <div className="flex flex-col ">
              ...
              <div className="flex flex-col ">
                <p className="leading-tight">
                  <span className="font-bold">Load Capacity:</span>
                  The Aero Bike boasts a robust frame and components, enabling
                  it to carry a maximum load of up to 150 kilograms (309
                  pounds).
                </p>
              </div>
              <div className="flex flex-col ">
