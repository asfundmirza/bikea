    ...
    <div>
              ...
              <div className="flex flex-col mt-8 px-8 gap-3">
                ...
                <div className="flex flex-col ">
                  <p className="leading-tight">
                    ...
                    hour), the Aero Bike allows you to zip through urban streets
                    and bike paths with ease
                  </p>
                </div>
                <div className="flex flex-col ">
                  <p className="leading-tight">
                    <span className="font-bold">Load Capacity:</span>
                    The Aero Bike boasts a robust frame and components, enabling
                    it to carry a maximum load of up to 140 kilograms (309
                    pounds).
                  </p>
                </div>
                <div className="flex flex-col ">
        ...
        <div className="md:hidden flex  flex-1 flex-col gap-4 mt-5 mb-3 px-8">
          <div className="flex flex-col gap-y-2">
            ...
            <p>
              ...
              offers an impressive 60 kilometers (37 miles) of riding on a
              single charge.
            </p>
          </div>
          <div className="flex flex-col gap-y-2">
            ...
            <p>
              With a top speed of 40 kilometers per hour (25 miles per hour),
              the Aero Bike allows you to zip through urban streets and bike
              paths with ease
            </p>
          </div>
          <div className="flex flex-col gap-y-2">
          ...
          <div className="flex flex-col gap-y-2">
            ...
            <p>
              Safety is a top priority with the Aero Bike. It comes equipped
              with a reliable and responsive braking system.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="md:hidden">
        ...
        <div className="flex  flex-1 flex-col gap-4 mt-5 mb-3 px-8">
          <div className="flex flex-col gap-y-2">
            ...
            <p>
              The Aero Bike is equipped with a powerful lithium-ion battery that
              offers an impressive 80 kilometers (37 miles) of riding on a
              single charge.
            </p>
          </div>
          <div className="flex flex-col gap-y-2">
            ...
            <p>
              With a top speed of 50 kilometers per hour (25 miles per hour),
              the Aero Bike allows you to zip through urban streets and bike
              paths with ease
            </p>
          </div>
      ...
      <div className="hidden md:block">
        <div className="flex mt-10 mb-10">
          <div className="flex items-center md:flex-col  justify-center md:justify-start mt-5 md:mt-[100px] flex-1 md:flex-[0.9]">
            <h1 className="font-semibold text-3xl md:text-5xl ">Aero Bike X</h1>
            <div className="hidden md:block ">
              <div className="flex mt-14  px-10">
                <div className="flex flex-col mt-8 px-8 gap-3">
                  <div className="flex flex-col ">
