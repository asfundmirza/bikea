        ...
        product.id === "price_1NodRWAdcivc1ys1jTk6jgp4" ? (
          <div key={product.id} className="flex flex-col md:flex-row  ">
            ...
            <div className="flex items-center flex-col  justify-center md:justify-start mt-5 md:mt-[100px] flex-1 md:flex-[0.9]">
              <h1 className="font-semibold font-heading tracking-[0.4rem] text-3xl md:text-5xl ">
                {product.title}
              </h1>
              ...
              <div className="flex flex-col md:flex-row mt-1 md:mb-12   px-1 md:pr-3">
                ...
                <div className="flex flex-col mt-5 md:mt-14 px-5 gap-3 space-y-4">
                  ...
                  <div className="hidden md:block  flex-col mt-5 gap-3 md:space-y-4">
                    ...
                    <button
                      ...
                      className="bg-buttonGreen border font-body font-medium p-1 px-6 rounded-[4px] text-center w-fit"
                    >
                      Add to Cart
                    </button>
                  </div>
